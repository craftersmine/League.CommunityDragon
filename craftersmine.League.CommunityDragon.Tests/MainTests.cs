...
namespace craftersmine.League.CommunityDragon.Tests
{
    ...
    public class MainTests
    {
        ...
        public void InitializationTests()
        {
            ...
            Assert.IsTrue(dragonEn.AssetsUri.ToString() == string.Format(AssetsUriFormat, "13.12"));
            Debug.WriteLine("Dragon Metadata EN-13.12: " + dragonEn.MetadataUri);
            Debug.WriteLine("Dragon Assets EN-13.12: " + dragonEn.AssetsUri);
            ...
            Assert.IsTrue(dragonRu.AssetsUri.ToString() == string.Format(AssetsUriFormat, "13.12"));
            Debug.WriteLine("Dragon Metadata RU-13.12: " + dragonRu.MetadataUri);
            Debug.WriteLine("Dragon Assets RU-13.12: " + dragonEn.AssetsUri);
